...
module Payr
  class Client
    def get_paybox_params_from params
      ...
      command_timestamp = URI::encode Time.now.utc.iso8601
      command_timestamp = '2013-10-10T23:02:12Z'
      returned_hash = {
        pbx_site: Payr.site_id,
        pbx_rang: Payr.rang,
